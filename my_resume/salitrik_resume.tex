...
%-------------------------------------------------------------------------------
%
% latexmk -e "$pdflatex=q/xelatex -synctex=1 -interaction=nonstopmode/" -pdf %|"C:/Program Files/Adobe/Reader 11.0/Reader/AcroRd32.exe" %.pdf
%
%
...
\position{Software Development Engineer{\enskip\cdotp\enskip}Electromechanical Engineer}
\address{ADDRESS}
...
%\vspace{-1em}
%\input{resume/memberships.tex}
%\newpage
%\input{resume/comparison_edu.tex}
%\input{resume/comparison_experience.tex}
